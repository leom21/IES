                        ...
                        if (rotateLabels % 360) {
                            ...
                            xTicks
                                    .attr('transform', function (d, i, j) {
                                        return 'rotate(' + rotateLabels + ' 25,10)'
                                    })
...
//                .y2(function(d) { return d.display.y2 })
                        .width(availableWidth)
                        .height(availableHeight)
...
// ohlcChart is just a historical chart with oclc bars and some tweaks
    ...
    nv.models.lineChart = function () {
        ...
        yAxis
                ...
                ;
        y2Axis
                .orient((rightAlignY2Axis) ? 'right' : 'left')
                ;
        ...
        var showTooltip = function (e, offsetElement) {
            var left = e.pos[0] + (offsetElement.offsetLeft || 0),
                    ...
                    x = xAxis.tickFormat()(lines.x()(e.point, e.pointIndex)),
                    y = yAxis.tickFormat()(lines.y()(e.point, e.pointIndex)),
                    y2 = yAxis.tickFormat()(lines.y2()(e.point, e.pointIndex)),
            ...
            selection.each(function (data) {
                ...
                if (!data || !data.length || !data.filter(function (d) {
                    ...
                    noDataText
                            .attr('x', margin.left + availableWidth / 2)
                            .attr('y', margin.top + availableHeight / 2)
                            .attr('y2', margin.top + availableHeight / 2)
                            .text(function (d) {
                                return d
                            });
                ...
                interactiveLayer.dispatch.on('elementMousemove', function (e) {
                    ...
                    if (allData.length > 2) {
                        var yValue = chart.yScale().invert(e.mouseY);
//                    var y2Value = chart.y2Scale().invert(e.mouseY);
                        var domainExtent = Math.abs(chart.yScale().domain()[0] - chart.yScale().domain()[1]);
                        var threshold = 0.03 * domainExtent;
                        var indexToHighlight = nv.nearestValueIndex(allData.map(function (d) {
                            return d.value
                ...
                interactiveLayer.dispatch.on('elementClick', function (e) {
                    ...
                    data.filter(function (series, i) {
                        ...
                        var y2Pos = chart.y2Scale()(chart.y2()(point, pointIndex));
                        allData.push({
                            point: point,
                            pointIndex: pointIndex,
                            pos: [pointXLocation, yPos, y2Pos],
        ...
        chart._options = Object.create({}, {
            ...
            rightAlignY2Axis: {get: function () {
                    return rightAlignY2Axis;
                }, set: function (_) {
                    rightAlignY2Axis = _;
                    y2Axis.orient(rightAlignY2Axis ? 'right' : 'left');
                }},
            useInteractiveGuideline: {get: function () {
                    return useInteractiveGuideline;
                }, set: function (_) {
            ...
            selection.each(function (data) {
                ...
                if (showXAxis) {
                    ...
                    if (rotateLabels)
                        xTicks
                                .selectAll('.tick text')
                                .attr('transform', 'rotate(' + rotateLabels + ' 25,10)')

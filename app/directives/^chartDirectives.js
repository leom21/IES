...
//                            if (i > 0) {
//                                var prevData = parseInt(data[0].values[i - 1].x);
//                                var currData = parseInt(date);
//                                currData = new Date(currData).getDate();
//                                prevData = new Date(prevData).getDate();
//                                if (currData - prevData > 1) {
//                                    var x = currData - prevData;
//                                    for (var n = 1; n < x; n++) {
//                                        data[0].values.push({x: date, y: 0});
//                                    }
//                                } else {
...
//                            chart.xDomain([data[0].values[0].x, data[0].values[data[0].values.length - 1].x]);
                            chart.yAxis
                                    .tickFormat(function (d) {
...
//                                        return dates[d];
                                        return d3.time.format('%x')(new Date(dates[d]));
                                    });
